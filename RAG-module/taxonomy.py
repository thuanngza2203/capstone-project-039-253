...
DISEASES: tuple[Disease, ...] = (
    ...
    Disease("grape", "black_rot", "grape/grape_black_rot.txt"),
    Disease("grape", "esca_black_measles", "grape/grape_esca.txt", ("esca",)),
    Disease("grape", "leaf_blight", "grape/grape_leaf_blight.txt",
    ...
    Disease("potato", "late_blight", "potato/potato_late_blight.txt"),
